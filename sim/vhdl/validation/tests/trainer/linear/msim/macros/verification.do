...
alias model_trainer_linear_verification_compilation {
  echo "TEST: MODEL_STANDARD_TRAINER_LINEAR_TEST"
  ...
  vsim -g /model_trainer_linear_testbench/ENABLE_MODEL_STANDARD_TRAINER_LINEAR_TEST=true -t ps +notimingchecks -L unisim work.model_trainer_linear_testbench
  ...
  force -freeze sim:/model_trainer_linear_pkg/STIMULUS_MODEL_STANDARD_TRAINER_LINEAR_TEST true 0
  force -freeze sim:/model_trainer_linear_pkg/STIMULUS_MODEL_STANDARD_TRAINER_LINEAR_CASE_0 true 0
